...
| **ผู้จัดทำ** | `<นนทชัย ไทยตัน> <68543210012-9>` |
...
```json
{ "error": "ไม่พบคำร้องรหัส REQ-007" }
```

> **คำถามที่ควรตอบในเอกสาร** — ลบแล้วยิง `GET` เส้นเดิมซ้ำจะได้อะไร · ลบซ้ำอันเดิมสองครั้งจะได้อะไร จะได้รับ 404 Not Found
...
| 2.0.0 | `<23/09/2026>` | เพิ่ม `PUT /api/requests/:id` และ CORS | ไม่ |
| `<...>` | `<...>` | `<...>` | `<...>` |
