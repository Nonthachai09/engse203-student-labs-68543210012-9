...
|---|---|---|
| 1 | POST เพิ่มคำร้องใหม่ | 201 |
| 2 | GET ดูรายการ — เห็นคำร้องใหม่ไหม | เห็นคำร้องใหม่ |
| 3 | Ctrl+C ปิดเซิร์ฟเวอร์ แล้วเปิดใหม่ | ยังเห็นคำร้องใหม่ |
| 4 | GET ดูรายการอีกครั้ง — คำร้องยังอยู่ไหม | คำร้องใหม่ไม่หายไป |
